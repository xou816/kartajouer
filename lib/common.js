(function(exports) {
    ...
    */
    ...
    exports.Card = function(value) {
        ...
        this.id = null;
        this.up = true; // Card facing up or down
    };

    exports.Card.prototype.flip = function() {
        this.up = !this.up;
    };

    exports.Card.prototype.public_value = function() {
        return (this.up ? this.value : 0);
    };
    ...
    */
    ...
    exports.Visibility.get_from_name = function(name) {
        var fun;
        exports.policy_namespace.some(function(namespace) {
            fun = namespace.Visibility[name];
            if (typeof fun !== 'undefined') return true;
        });
        return fun;
    };

    exports.Visibility.upside = function(stack) {
        stack.forEach(function(card) {
            card.up = true;
        });
    };

    exports.Visibility.downside = function(stack) {
        stack.forEach(function(card) {
            card.up = false;
        });
    };
    ...
    */
    ...
    exports.Spot = function(x, y, width, height) {
        ...
        // Layout defines how cards are displayed/organized for the client
        this.layout = {};
        // Visibility defines what side of the cards should be shown
        // The visibility handler functions are executed both client and server side
        this.visibility = {
    ...
    // Fallback for undefined idle contexts
    exports.Spot.prototype.get_context_property = function(property) {
        var value = this[property][this.context];
        if (this.context.startsWith('idle_') && typeof value === 'undefined') {
            return this[property][this.context.substring(5)];
        } else {
            return value;
        }
        // return this[property][this.context];
    };

    exports.Spot.prototype.update_visibility = function() {
        exports.Visibility.get_from_name(this.get_context_property('visibility').drop).call(null, this.stack);
        exports.Visibility.get_from_name(this.get_context_property('visibility').drag).call(null, this.drag_stack);
    };
    ...
    exports.Spot.prototype.export = function() {
        ...
        data.stack = [];
        // If cards are face down, set card values to 0 for client
        this.update_visibility();
        this.stack.forEach(function(card) {
            data.stack.push({
                id: card.id,
                value: card.public_value(),
            });
        });
    ...
    exports.Spot.prototype.filter_drag = function(matches) {
        return new exports.Stack(exports.DragPolicy.get_from_string(this.get_context_property('policy').drag, this, matches));
    };
    ...
    exports.Spot.prototype.accept_drop = function(from, stack) {
        return exports.DropPolicy.get_from_string(this.get_context_property('policy').drop, from, this, stack);
    };
    ...
    // Push to drag_stack (free as in free from drop layout)
